...
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AQ.Ab8RN6KEenDNyqFVQ0HiOFb78TfNPnEuU2sUL9-63wLgP9Licg")
...
def analyze():
    ...
    if has_image:
        format_reminder = (
            ...
            "reformat the tag names themselves (the content inside can be in the "
            "farmer's language, but the tag names must stay in English exactly as given).\n"
            "- Every one of these six tags must appear exactly once, even if brief:\n"
            "[DIAGNOSIS]title|severity(High/Medium/Low)|confidence%[/DIAGNOSIS]\n"
            "[WHAT_IS_HAPPENING]...[/WHAT_IS_HAPPENING]\n"
            "[TREATMENT_COMPARISON]Chemical: ... | Organic: ... | IPM: ... | Recommendation: ... (include cost, speed, impact)[/TREATMENT_COMPARISON]\n"
